...
class Solution:
    def intersection(self, nums1: List[int], nums2: List[int]) -> List[int]:
        ...
        #     for num2 in nums2:
        #         # If a match is found (num1==num2)
        #         # And this element is not already in our result list
        #         # Then add it to the result list
        #         if num1 == num2 and num1 not in result:
        #             result.append(num1)
        #             # Once a match is found and added, break the inner loop to move to the next element in nums1
        #             break
        # return result
        ...
        #             ptr2 +=1
        #         else:
        #             # We need 'not result' to handle the case when 'result' is empty to avoid an IndexError when accessing result[-1]
        ...
        # for num in nums1:
        #     counts[num]+=1
        # # We use a set for the result because the problem asks for unique intersection elements.
        # result_set = set()
        ...
        #         result_set.add(num)
        # # Finally, convert the result set to a list
